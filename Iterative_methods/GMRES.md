...
GMRES relys heavily on ***Arnold Decomposition*** which is to project a large matrix(high dim) to smaller ones(low dim), check out more about Arnold Decomposition ***[here]()***
